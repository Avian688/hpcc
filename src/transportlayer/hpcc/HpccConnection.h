...
#ifndef TRANSPORTLAYER_HPCC_LEOTCPCONNECTION_H_
#define TRANSPORTLAYER_HPCC_LEOTCPCONNECTION_H_
...
namespace inet {
namespace tcp {
class HpccConnection : public TcpConnection {
public:
    HpccConnection();
    virtual ~HpccConnection();
protected:
...
#endif /* TRANSPORTLAYER_HPCC_HPCCCONNECTION_H_ */
