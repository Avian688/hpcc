...
Register_Class(HpccSendQueue);

Packet *HpccSendQueue::createSegmentWithBytes(uint32_t fromSeq, uint32_t numBytes)
{
...
void HpccSendQueue::discardUpTo(uint32_t seqNum)
{
